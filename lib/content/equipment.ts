...
export const maxMasterSlim = {
  name: "MaxMaster Slim",
  tagline: "Non-invasive body contouring & slimming",
  short:
    "A complementary Bravo platform focused on circumference-focused body contouring—designed for structured, comfortable sessions without surgery and with minimal disruption to daily life.",
  highlights: [
    {
      title: "Contour-first workflow",
      body:
        "Built for practices that want a clear, repeatable slimming and body-contouring protocol with measurable checkpoints over a treatment series.",
    },
    {
  ...
  specs: [
    { label: "Focus", value: "Body contouring & slimming" },
    { label: "Model", value: "MaxMaster Slim" },
    { label: "Setting", value: "Professional in-office use" },
  ],
  imageryNote:
    "Product photography and full technical sheets for MaxMaster Slim will be added when assets are available.",
} as const;
