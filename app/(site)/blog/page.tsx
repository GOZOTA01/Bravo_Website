...
export const metadata = {
  title: "Blog / News",
  description:
    "Education and updates from Bravo Laser—body contouring guidance, provider growth articles, and clinic spotlights. Built for future CMS/Supabase-backed posts.",
};
...
const placeholderPosts = [
  ...
  },
  {
    ...
    category: "Providers",
    excerpt:
      "Positioning, workflow, and conversion fundamentals for practices adding a modern body contouring service line.",
  },
  {
